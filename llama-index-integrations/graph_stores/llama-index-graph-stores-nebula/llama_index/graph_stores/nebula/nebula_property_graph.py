    ...
    def upsert_nodes(self, nodes: List[LabelledNode]) -> None:
        ...
        for i, entity in enumerate(nodes):
            ...
            if entity.label not in schema_ensurence_cache:
                if ensure_node_meta_schema(entity.label, self.structured_schema, self.client, entity.properties):
                    self.refresh_schema()
    ...
    def upsert_relations(self, relations: List[Relation]) -> None:
        ...
        for relation in relations:
            ...
            if relation.label not in schema_ensurence_cache:
                if ensure_relation_meta_schema(relation.source_id, relation.target_id, relation.label, self.structured_schema, self.client, relation.properties):
                    self.refresh_schema()
